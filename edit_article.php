...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $ten_bhat = $_POST['txtCatTenbaihat'] ?? ''; 
        ...
        if (!empty($ma_bviet) && !empty($tieude) && !empty($ten_bhat) && !empty($ma_tloai) && !empty($tomtat) && !empty($noidung) && !empty($ma_tgia)) {
            $articleController->update($ma_bviet, $tieude, $ten_bhat, $ma_tloai, $tomtat, $noidung, $ma_tgia, $ngayviet, $hinhanh);
