                    ...
                    <?php
                        if ($result->num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                                ...
                                echo "<td><a href='edit_author.php?this_id=" .$row['ma_tgia']."'><i class='fa-solid fa-pen-to-square'></i></a></td>";
                                echo "<td><a href='delete_author.php?this_id=" .$row['ma_tgia']."'><i class='fa-solid fa-trash-can'></i></a></td>";
                                echo "</tr>";
                            }
                        }else{
                            echo "Không có tác giả nào.";
                        }
                         ?>
                    </tbody>
                </table>
