...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        // Lấy dữ liệu từ form
        $ten_tgia = $conn->real_escape_string($_POST['txtCatName']);
        $hinh_tgia = $conn->real_escape_string($_POST['txtCatPicture']);
        
        $sql_add = "INSERT INTO tacgia (ten_tgia, hinh_tgia) VALUES ('$ten_tgia','$hinh_tgia')";
